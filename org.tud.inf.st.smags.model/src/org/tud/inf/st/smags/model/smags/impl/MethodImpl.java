 ...
 * </p>
 * <ul>
 *   <li>{@link org.tud.inf.st.smags.model.smags.impl.MethodImpl#getReturnType <em>Return Type</em>}</li>
 *   <li>{@link org.tud.inf.st.smags.model.smags.impl.MethodImpl#getArgs <em>Args</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MethodImpl extends PortTypeElementImpl implements Method {
	/**
	...
	protected EClass eStaticClass() {
		return SmagsPackage.Literals.METHOD;
	}
	...
	public void setReturnType(Variable newReturnType) {
		if (newReturnType != returnType) {
			...
			if (returnType != null)
				msgs = ((InternalEObject)returnType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SmagsPackage.METHOD__RETURN_TYPE, null, msgs);
			if (newReturnType != null)
				msgs = ((InternalEObject)newReturnType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SmagsPackage.METHOD__RETURN_TYPE, null, msgs);
			msgs = basicSetReturnType(newReturnType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmagsPackage.METHOD__RETURN_TYPE, newReturnType, newReturnType));
	}
	...
	public EList<Variable> getArgs() {
		if (args == null) {
			args = new EObjectContainmentEList<Variable>(Variable.class, this, SmagsPackage.METHOD__ARGS);
		}
		return args;
	}
