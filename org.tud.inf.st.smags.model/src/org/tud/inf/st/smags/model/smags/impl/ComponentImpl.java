 ...
 * </p>
 * <ul>
 *   <li>{@link org.tud.inf.st.smags.model.smags.impl.ComponentImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentImpl extends ArchitectureElementImpl implements Component {
	...
	protected EClass eStaticClass() {
		return SmagsPackage.Literals.COMPONENT;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SmagsPackage.COMPONENT__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(ComponentType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmagsPackage.COMPONENT__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SmagsPackage.COMPONENT__TYPE:
