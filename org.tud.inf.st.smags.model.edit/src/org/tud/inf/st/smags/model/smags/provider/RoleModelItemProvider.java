...
/**
 * This is the item provider adapter for a {@link org.tud.inf.st.smags.model.smags.RoleModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoleModelItemProvider extends MetaArchitectureElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SmagsPackage.Literals.ROLE_MODEL__INITIALIZATION);
			childrenFeatures.add(SmagsPackage.Literals.ROLE_MODEL__SLOTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SmagsPackage.Literals.ROLE_MODEL__INITIALIZATION,
				 SmagsFactory.eINSTANCE.createBindOperator()));

		newChildDescriptors.add
			(createChildParameter
				(SmagsPackage.Literals.ROLE_MODEL__SLOTS,
				 SmagsFactory.eINSTANCE.createRoleModelSlot()));
	}
