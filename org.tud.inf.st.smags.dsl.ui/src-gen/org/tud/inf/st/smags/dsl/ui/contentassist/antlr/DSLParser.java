 ...
 * generated by Xtext
 */
package org.tud.inf.st.smags.dsl.ui.contentassist.antlr;
...
public class DSLParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.tud.inf.st.smags.dsl.ui.contentassist.antlr.internal.InternalDSLParser createParser() {
		org.tud.inf.st.smags.dsl.ui.contentassist.antlr.internal.InternalDSLParser result = new org.tud.inf.st.smags.dsl.ui.contentassist.antlr.internal.InternalDSLParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAnonymousVariableAccess().getTypeAssignment(), "rule__AnonymousVariable__TypeAssignment");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.tud.inf.st.smags.dsl.ui.contentassist.antlr.internal.InternalDSLParser typedParser = (org.tud.inf.st.smags.dsl.ui.contentassist.antlr.internal.InternalDSLParser) parser;
